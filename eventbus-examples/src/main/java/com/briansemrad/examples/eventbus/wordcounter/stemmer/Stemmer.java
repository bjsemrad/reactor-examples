package com.briansemrad.examples.eventbus.wordcounter.stemmer;
/*
...
public class Stemmer {
   ...
   /* cons(i) is true <=> b[i] is a consonant. */
    ...
    private boolean cons(final int i) {
        switch (b[i]) {
            case 'a':
            case 'e':
            case 'i':
     ...
     */
    private boolean doublec(final int j) {
        if (j < 1) return false;
     ...
     * snow, box, tray.
     */
    private boolean cvc(final int i) {
    ...
    private boolean ends(final String s) {
        int l = s.length();
        int o = k - l + 1;
        if (o < 0) return false;
